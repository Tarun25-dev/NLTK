...
if st.button("Predict"):
    if user_input.strip() != "":
        ...
        probabilities = model.predict_proba(transformed_text) # it outputs between 0 to 1 and it  ouputs two values looks like this [[0.4,0.6]] which means 40% negative and 60% positive both are stored in index 0
        confidence = max(probabilities[0]*100) # we take maximum value and convert to 100 percentage.
